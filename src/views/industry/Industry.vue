<template>
  <div>
    ...
    <!-- 抽屉 -->
    <Drawer v-if="type === '1'" :visible="drawerShow" ref="industryDrawer" class="industry-drawer" @handleDrawerClose="handleDrawerClose">
        <Drawer-Button
          slot="button"
    ...
    <Download-Button v-if="type === '1'" :loadingProgress="loadingProgress" :iconName="iconName"/>
    <!-- 行业提数 -->
