<template>
  <div style="width: 1030px">
    ...
    <Type-Buttons
      ...
      @handleChangeActiveType="activedType = $event"/>
...
export default {
  name: 'TabForPortrait',
  components: { TypeButtons, TableHeaderTooltip, PreviewTableTitle, ShopTags },
  data () {
    return {
      activedType: 'phone',
      tableData: MOCK_DATA,
...
.sum-title
  ...
  span
    ...
    margin-left 5px
.batch-form-wapper
  // border 1px dashed $color-light-gary
  padding 0px 12px
  margin-left 82px
  .el-form-item
    margin-bottom 0
